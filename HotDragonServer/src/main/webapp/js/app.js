...
$(document).ready(function () {
    ...
    function about() {
        $.ajax({
            url: "http://localhost:12345/HotDragonServiciiWeb/webapi/myresource",
            method: "POST",
            dataType: "json",
    ...
    function unde() {
        $.ajax({
            ...
            success: function (data) {
                ...
                $("#unde").html(data[0].contents[0].title);
            }
        })
    }
            ...
            if(event.target.parentElement.classList.contains('store-item-icon'))
                {
                    ...
                    <img src="${item.img}" class="img-fluid rounded-circle" id="item-img" alt="">
                        <div class="item-text">
                          ...
                          <span class="cart-item-price" id="cart-item-price" class="mb-0">${item.price}</span>
                          <span>lei</span>
                        </div>
