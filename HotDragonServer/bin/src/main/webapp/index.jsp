...
https://www.iconfinder.com/korawan_m
    ...
    <nav class="navbar navbar-expand-lg px-4">
      ...
      <div class="collapse navbar-collapse" id="myNav">
        <ul class="navbar-nav mx-auto">
          ...
          <li class="nav-item">
            <a id="unde" class="nav-link " href="#undeNeGasesti">Unde ne gÄseÈti</a>
          </li>
          <li class="nav-item">
        ...
        <div class="nav-info-items d-none d-lg-flex ">
          ...
          <div id="cart-info" class="nav-info align-items-center cart-info d-flex justify-content-between mx-lg-5">
            ...
            <p class="mb-0  "><span id="item-count">CoÈ de </span> cumpÄrÄturi <span class="item-total"></span></p>
          </div>
          <!-- end of single info -->
        </div>
      </div>
    ...
    <div class="container-fluid">
      <div class="row max-height justify-content-center align-items-center">
        <div class="col-10 mx-auto banner text-center">
          <h1>Bine aÈi venit pe <strong class="banner-title ">Hot Dragon</strong></h1>
          <a href="#store" class="btn banner-link text-uppercase my-2">ComandÄ</a>
    ...
    <div class="container">
      ...
      <div class="row" id='about'>
        <div class="col-10 mx-auto col-md-6 my-5">
          ...
          <p class="my-4" id='font-size'>Noi suntem HOT DRAGON, partenerul tÄu de Ã®ncredere atunci cÃ¢nd vine vorba de mÃ¢ncarea cu specific asiatic.
            Poti Ã®ncerca oricÃ¢nd serviciul nostru Èi te poÈi bucura la orice orÄ de cea mai bunÄ mÃ¢ncare asiaticÄ din oraÈ.
            Acum Ã®Èi poÈi savura mÃ¢ncarea preferatÄ Ã®n cel mai scurt timp posibil. Ai garantat comanda la usÄ Ã®n doar 30 de minute.
          </p>
          <a href="#" class="btn btn-outline-secondary btn-black text-uppercase ">AcasÄ</a>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-10 mx-auto col-sm-6 text-center">
          <h1 class="text-capitalize"> <strong class="banner-title ">Unde ne gÄseÈti</strong></h1>
        </div>
      </div>
          ...
          <div class="card ">
            ...
            <div class="card-body">
              <div class="card-text d-flex justify-content-between">
                <h5 class="banner-title1">IaÈi - zona Palas</h5>
              </div>
            </div>
          </div>
        </div>
  ...
  <section id="store" class="store py-5">
    <div class="container">
      ...
      <div class="row">
        <div class="col-10 mx-auto col-sm-6 text-center">
          <h1 class="text-capitalize">BucÄtÄria <strong class="banner-title ">noastrÄ</strong></h1>
        </div>
      </div>
      ...
      <div class="row" class="store-items" id="store-items">
        ...
        <div class="col-10 col-sm-6 col-lg-4 mx-auto my-3 store-item sweets" data-item="sweets">
          <div class="card ">
            ...
            <div class="card-body">
              <div class="card-text d-flex justify-content-between">
                <h5 id="store-item-name">TÄieÈei cu porc Èi legume</h5>
        ...
        <div class="col-10 col-sm-6 col-lg-4 mx-auto my-3 store-item cupcakes" data-item="cupcakes">
          <div class="card ">
            ...
            <div class="card-body">
              <div class="card-text d-flex justify-content-between">
                <h5 id="store-item-name">TÄieÈei cu vitÄ Èi legume</h5>
                <h5 class="store-item-value">lei <strong id="store-item-price">20</strong></h5>
        ...
        <div class="col-10 col-sm-6 col-lg-4 mx-auto my-3 store-item cakes" data-item="cakes">
          <div class="card ">
            ...
            <div class="card-body">
              <div class="card-text d-flex justify-content-between">
                <h5 id="store-item-name">TÄieÈei cu carne Èi legume</h5>
        ...
        <div class="col-10 col-sm-6 col-lg-4 mx-auto my-3 store-item doughnuts" data-item="dougnuts">
          <div class="card ">
            ...
            <div class="card-body">
              <div class="card-text d-flex justify-content-between">
                <h5 id="store-item-name">Orez cu vitÄ Èi legume</h5>
        ...
        <div class="col-10 col-sm-6 col-lg-4 mx-auto my-3 store-item sweets" data-item="sweets">
          <div class="card ">
            ...
            <div class="card-body">
              <div class="card-text d-flex justify-content-between">
                <h5 id="store-item-name">VitÄ cu legume </h5>
        ...
        <div class="col-10 col-sm-6 col-lg-4 mx-auto my-3 store-item cupcakes" data-item="cupcakes">
          <div class="card ">
            ...
            <div class="card-body">
              <div class="card-text d-flex justify-content-between">
                <h5 id="store-item-name">Orez cu creveÈi Èi legume </h5>
        ...
        <div class="col-10 col-sm-6 col-lg-4 mx-auto my-3 store-item cakes" data-item="cakes">
          <div class="card ">
            ...
            <div class="card-body">
              <div class="card-text d-flex justify-content-between">
                <h5 id="store-item-name">SupÄ cu legume </h5>
        ...
        <div class="col-10 col-sm-6 col-lg-4 mx-auto my-3 store-item doughnuts" data-item="dougnuts">
          <div class="card ">
            ...
            <div class="card-body">
              <div class="card-text d-flex justify-content-between">
                <h5 id="store-item-name">Orez cu carne Èi legume</h5>
        ...
        <div class="col-10 col-sm-6 col-lg-4 mx-auto my-3 store-item sweets" data-item="sweets">
          <div class="card ">
            ...
            <div class="card-body">
              <div class="card-text d-flex justify-content-between">
                <h5 id="store-item-name">PacheÈele de primÄvarÄ</h5>
                <h5 class="store-item-value">lei <strong id="store-item-price">20</strong></h5>
        ...
        <div class="col-10 col-sm-6 col-lg-4 mx-auto my-3 store-item cupcakes" data-item="cupcakes">
          <div class="card ">
            ...
            <div class="card-body">
              <div class="card-text d-flex justify-content-between">
                <h5 id="store-item-name">SupÄ cu creveÈi </h5>
        ...
        <div class="col-10 col-sm-6 col-lg-4 mx-auto my-3 store-item doughnuts" data-item="dougnuts">
          <div class="card ">
            ...
            <div class="card-body">
              <div class="card-text d-flex justify-content-between">
                <h5 id="store-item-name">Pui cu legume Èi susan </h5>
